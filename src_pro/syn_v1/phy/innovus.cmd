...
#  Created on Wed Sep 16 05:28:13 2020                
#                                                     
#######################################################
...
setPinAssignMode -pinEditInBatch true
editPin -fixOverlap 1 -spreadDirection clockwise -side Right -layer 1 -spreadType side -pin {{IRAM_ADDR[0]} {IRAM_ADDR[1]} {IRAM_ADDR[2]} {IRAM_ADDR[3]} {IRAM_ADDR[4]} {IRAM_ADDR[5]}}
setPinAssignMode -pinEditInBatch true
...
timeDesign -postRoute -pathReports -drvReports -slackReports -numPaths 10 -prefix DLX_setup_postRoute -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -hold -pathReports -slackReports -numPaths 10 -prefix DLX_hold_postRoute -outDir timingReports
get_time_unit
...
saveNetlist DLX_ROUTED.v
all_hold_analysis_views 
all_setup_analysis_views 
write_sdf  -ideal_clock_network DLX_ROUTED.sdf
